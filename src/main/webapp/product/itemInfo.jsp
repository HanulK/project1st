	...
	<div class="app-container">
		<div class="info-wrap">
			...
			<div class="item_visual" id="imageDiv">
				<ul>
					<li><img
						src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W01.jpg/dims/resize/684x1032"
						class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img
						src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W02.jpg/dims/resize/684x1032"
						class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img
						src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W03.jpg/dims/resize/684x1032"
						class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img
						src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W04.jpg/dims/resize/684x1032"
						class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img
						src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W05.jpg/dims/resize/684x1032"
						class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img
						src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W06.jpg/dims/resize/684x1032"
						class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img
						src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W07.jpg/dims/resize/684x1032"
						class="respon_image" alt="자수 후드 티셔츠" /></li>
				</ul>
			</div>
			<!-- 정보 박스 -->
					...
					<div class="info_sect">
						<h4 class="item_name">
							<div class="brand-name">
								<a href="#">TOM GREYHOUND</a> &gt; <a href="#">TOM GREYHOUND</a>
							</div>
							<span class="name"> 자수 후드 티셔츠<input type="hidden"
								id="brandName" value="TOM GREYHOUND" /> <input type="hidden"
								id="productName" value="자수 후드 티셔츠" /> <input type="hidden"
								id="productCode" value="TN2CATTO616W_CR" />
							</span>
						</h4>
						...
						<p class="price">
							<span>₩295,000</span> <input type="hidden" id="productPrice"
								value="295000" />
						</p>
						...
						<div class="prod-detail-con-box">
							...
							<div class="round-style">
								<p>탄탄한 100% 면 소재를 사용하여 편안한 착용감을 선사하는 후드 티셔츠입니다. 화사한 컬러감이
									매력적이며, 입체감 있는 라인을 더해 포인트 디테일을 섬세하게 완성하였습니다. 같은 소재로 제작된 팬츠와 함께
									레이어 하여 캐주얼한 무드로 연출하기에도 좋은 아이템입니다.</p>
							</div>
							<div class="fit-info">
					...
					<div class="info_sect">
						<div class="prod-detail-con-more">
							<details class="more-con-box">
								...
								<ul>
									<li>- 100% 면 소재<br />- 넥라인의 드로우스트링<br />- 앞면의 캥거루 포켓<br />-
										소맷단과 밑단 리브 마감
									</li>
								</ul>
							</details>
						...
						<div class="item_option_box info_sect" id="color_size">
							<ul class="color_size_qty">
								<li><span class="title">사이즈</span> <label><input
										type="radio" name="size" value="44" />44</label> <label><input
										type="radio" name="size" value="55" />55</label> <label><input
										type="radio" name="size" value="66" />66</label></li>
								...
								<li><span class="title">수량</span> <span class="txt">
										<span class="qty_sel num"> <!-- T0D0 +/- 기능 추가 -->
											...
											id="txtqty" name="txtqty" value="1" readonly="readonly" />
										...
										<dd>
											...
											<ol class="numlist">
												...
												<li><span class="num sum">-</span> <span class="txt">화장품
														...
														가능(용량 1/3 미만 사용 및 의사소견서 1:1문의 첨부 필수)</span></li>
