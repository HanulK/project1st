	...
	<div class="app-container">
		<div class="info-wrap">
			...
			<div class="item_visual" id="imageDiv">
				<ul>
					<li><img src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W01.jpg/dims/resize/684x1032" class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W02.jpg/dims/resize/684x1032" class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W03.jpg/dims/resize/684x1032" class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W04.jpg/dims/resize/684x1032" class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W05.jpg/dims/resize/684x1032" class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W06.jpg/dims/resize/684x1032" class="respon_image" alt="자수 후드 티셔츠" /></li>

					<li><img src="http://newmedia.thehandsome.com/TN/2C/FW/TN2CATTO616W_CR_W07.jpg/dims/resize/684x1032" class="respon_image" alt="자수 후드 티셔츠" /></li>
				</ul>
			</div>
			<!-- 정보 박스 -->
				...
				<div class="info">
					<div class="info_sect">
						<h4 class="item_name">
							<div class="brand-name">
								<a href="#">TOM GREYHOUND</a>
								&gt;
								<a href="#">TOM GREYHOUND</a>
							</div>
							<span class="name"> 자수 후드 티셔츠<input type="hidden" id="brandName" value="TOM GREYHOUND" /> <input type="hidden" id="productName" value="자수 후드 티셔츠" /> <input type="hidden" id="productCode" value="TN2CATTO616W_CR" />
							</span>
						</h4>
						...
						<p class="price">
							<span>₩295,000</span>
							<input type="hidden" id="productPrice" value="295000" />
						</p>
						<p class="selling_point"></p>
						<div class="prod-detail-con-box">
							<strong class="number-code">상품품번 &#58; <span>TN2CATTO616W_CR</span></strong>
							<div class="round-style">
								<p>탄탄한 100% 면 소재를 사용하여 편안한 착용감을 선사하는 후드 티셔츠입니다. 화사한 컬러감이 매력적이며, 입체감 있는 라인을 더해 포인트 디테일을 섬세하게 완성하였습니다. 같은 소재로 제작된 팬츠와 함께 레이어 하여 캐주얼한 무드로 연출하기에도 좋은 아이템입니다.</p>
							</div>
							<div class="fit-info">
								<p class="size-text">- 피팅 정보 : 172cm, 55 사이즈 모델이 S 사이즈 착용</p>
							</div>
						</div>
					</div>
					<!-- 세부 사항 -->
					<div class="info_sect">
						<div class="prod-detail-con-more">
							<details class="more-con-box">
								<summary class="more-btn">
									더보기<i></i>
								</summary>
								<ul>
									<li>- 100% 면 소재<br />- 넥라인의 드로우스트링<br />- 앞면의 캥거루 포켓<br />- 소맷단과 밑단 리브 마감
									</li>
								</ul>
							</details>
						</div>
					...
					<div class="item_option_box info_sect" id="color_size">
						<ul class="color_size_qty">
							<li><span class="title">사이즈</span> <label><input type="radio" name="color" value="red" />44</label> <label><input type="radio" name="color" value="green" />55</label> <label><input type="radio" name="color" value="blue" />66</label></li>
							<li><span class="title">색상</span> <label><input type="radio" name="color" value="red" />R</label> <label><input type="radio" name="color" value="green" />G</label> <label><input type="radio" name="color" value="blue" />B</label></li>
							<li><span class="title">수량</span> <span class="txt"> <span class="qty_sel num"> <!-- T0D0 +/- 기능 추가 -->
										<button class="left opt_btn">－</button> <input type="text" id="txtqty" title="수량" value="1" readonly="readonly" />
						...
						<dl class="toggle_type1">
							...
							<details>
								...
								<div class="detail_contents">
									<strong>상품품번 :</strong> TN2CATTO616W
									<br />
									<strong>품목 :</strong> 의류
									<br />
									<strong>소재 :</strong> 겉감 면 100%, 배색 면 95%, 폴리우레탄 5%(CR)
									<br />
									<strong>색상 :</strong> CR(CREAM)
									<br />
									<strong>사이즈 :</strong> S
									<br />
